...
final class Types {
    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType {
        ...
        public String toString() {
            ...
            result.append(Condition.Operation.LESS_THAN).append(Types.typeToString(this.typeArguments[0]));
            for (int i = 1; i < this.typeArguments.length; i++) {
                result.append(", ").append(Types.typeToString(this.typeArguments[i]));
            }
            return result.append(Condition.Operation.GREATER_THAN).toString();
        }
    }
