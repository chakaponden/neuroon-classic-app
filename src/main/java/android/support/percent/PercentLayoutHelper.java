...
public class PercentLayoutHelper {
    ...
    public static class PercentLayoutInfo {
        ...
        public void fillLayoutParams(ViewGroup.LayoutParams params, int widthHint, int heightHint) {
            ...
            if (params.width != 0 || this.widthPercent >= 0.0f) {
                widthNotSet = false;
            } else {
                widthNotSet = true;
            }
            if (params.height != 0 || this.heightPercent >= 0.0f) {
                heightNotSet = false;
            } else {
                heightNotSet = true;
            }
            ...
            if (this.aspectRatio >= 0.0f) {
                if (widthNotSet) {
                    params.width = (int) (((float) params.height) * this.aspectRatio);
                }
                if (heightNotSet) {
                    params.height = (int) (((float) params.width) / this.aspectRatio);
                }
            }
