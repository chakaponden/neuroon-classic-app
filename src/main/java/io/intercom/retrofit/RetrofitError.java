...
public class RetrofitError extends RuntimeException {
    ...
    public static RetrofitError networkError(String url2, IOException exception) {
        return new RetrofitError(exception.getMessage(), url2, (Response) null, (Converter) null, (Type) null, Kind.NETWORK, exception);
    }
    ...
    public static RetrofitError httpError(String url2, Response response2, Converter converter2, Type successType2) {
        return new RetrofitError(response2.getStatus() + " " + response2.getReason(), url2, response2, converter2, successType2, Kind.HTTP, (Throwable) null);
    }

    public static RetrofitError unexpectedError(String url2, Throwable exception) {
        return new RetrofitError(exception.getMessage(), url2, (Response) null, (Converter) null, (Type) null, Kind.UNEXPECTED, exception);
    }
