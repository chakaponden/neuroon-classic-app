...
public class UnorderedList implements UnorderedListBlock {
    private final Context context;
    private final LayoutInflater inflater;
    private final StyleType style;

    public UnorderedList(Context context2, StyleType style2) {
    ...
    public View addUnorderedList(List<String> items, boolean isFirstObject, boolean isLastObject, ViewGroup parent) {
        ...
        while (i < size) {
            ...
            if (!item.isEmpty()) {
                ...
                spannableString.setSpan(new UnorderedListSpan(lineIndent, this.context), 0, source.length(), 0);
