...
public class EglUtils {
    public static int getEGLMaxTextureSize() {
        if (Build.VERSION.SDK_INT >= 17) {
            return getEGL2MaxTextureSize();
        }
        return getEGL1MaxTextureSize();
    }

    @TargetApi(17)
    public static int getEGL2MaxTextureSize() {
        ...
        IntercomLogger.INTERNAL("lightbox", "egl 17+: " + maxSize[0]);
    ...
    public static int getEGL1MaxTextureSize() {
        ...
        IntercomLogger.INTERNAL("lightbox", "egl 16-: " + maxSize[0]);
