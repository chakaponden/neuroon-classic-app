...
public class LruCache implements Cache {
    ...
    private void trimToSize(int r7) {
        ...
        L_0x0043:
            ...
            int r3 = r6.size     // Catch:{ all -> 0x0032 }
            int r4 = io.intercom.com.squareup.picasso.Utils.getBitmapBytes(r2)     // Catch:{ all -> 0x0032 }
            int r3 = r3 - r4
            ...
            goto L_0x0000
        */
        throw new UnsupportedOperationException("Method not decompiled: io.intercom.com.squareup.picasso.LruCache.trimToSize(int):void");
    }
