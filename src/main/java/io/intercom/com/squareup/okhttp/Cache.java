...
import io.intercom.com.squareup.okhttp.internal.DiskLruCache;
...
import io.intercom.com.squareup.okhttp.internal.http.HttpMethod;
...
import io.intercom.okio.ForwardingSource;
...
public final class Cache {
    ...
    private final class CacheRequestImpl implements CacheRequest {
        ...
        public void abort() {
            /*
                r2 = this;
                io.intercom.com.squareup.okhttp.Cache r1 = io.intercom.com.squareup.okhttp.Cache.this
                monitor-enter(r1)
            ...
            L_0x0009:
                ...
                io.intercom.com.squareup.okhttp.Cache r0 = io.intercom.com.squareup.okhttp.Cache.this     // Catch:{ all -> 0x001f }
                io.intercom.com.squareup.okhttp.Cache.access$908(r0)     // Catch:{ all -> 0x001f }
                monitor-exit(r1)     // Catch:{ all -> 0x001f }
                io.intercom.okio.Sink r0 = r2.cacheOut
                io.intercom.com.squareup.okhttp.internal.Util.closeQuietly((java.io.Closeable) r0)
                io.intercom.com.squareup.okhttp.internal.DiskLruCache$Editor r0 = r2.editor     // Catch:{ IOException -> 0x001d }
            ...
            L_0x001f:
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: io.intercom.com.squareup.okhttp.Cache.CacheRequestImpl.abort():void");
        }
