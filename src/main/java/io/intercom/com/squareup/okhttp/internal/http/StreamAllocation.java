...
import io.intercom.com.squareup.okhttp.internal.RouteDatabase;
...
public final class StreamAllocation {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:33:0x0057, code lost:
        r0 = new io.intercom.com.squareup.okhttp.internal.io.RealConnection(r9.routeSelector.next());
        acquire(r0);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:36:?, code lost:
        io.intercom.com.squareup.okhttp.internal.Internal.instance.put(r9.connectionPool, r0);
        r9.connection = r0;
     */
    ...
    private io.intercom.com.squareup.okhttp.internal.io.RealConnection findConnection(int r10, int r11, int r12, boolean r13) throws java.io.IOException, io.intercom.com.squareup.okhttp.internal.http.RouteException {
        /*
            r9 = this;
            io.intercom.com.squareup.okhttp.ConnectionPool r2 = r9.connectionPool
            monitor-enter(r2)
        ...
        L_0x000f:
            ...
            throw r1
        L_0x0012:
            io.intercom.com.squareup.okhttp.internal.http.HttpStream r1 = r9.stream     // Catch:{ all -> 0x000f }
        ...
        L_0x001e:
            ...
            throw r1     // Catch:{ all -> 0x000f }
        L_0x002a:
            io.intercom.com.squareup.okhttp.internal.io.RealConnection r6 = r9.connection     // Catch:{ all -> 0x000f }
        ...
        L_0x0033:
            return r6
        L_0x0034:
            io.intercom.com.squareup.okhttp.internal.Internal r1 = io.intercom.com.squareup.okhttp.internal.Internal.instance     // Catch:{ all -> 0x000f }
            io.intercom.com.squareup.okhttp.ConnectionPool r3 = r9.connectionPool     // Catch:{ all -> 0x000f }
            io.intercom.com.squareup.okhttp.Address r4 = r9.address     // Catch:{ all -> 0x000f }
            io.intercom.com.squareup.okhttp.internal.io.RealConnection r7 = r1.get(r3, r4, r9)     // Catch:{ all -> 0x000f }
            ...
            goto L_0x0033
        L_0x0045:
            io.intercom.com.squareup.okhttp.internal.http.RouteSelector r1 = r9.routeSelector     // Catch:{ all -> 0x000f }
            if (r1 != 0) goto L_0x0056
            io.intercom.com.squareup.okhttp.internal.http.RouteSelector r1 = new io.intercom.com.squareup.okhttp.internal.http.RouteSelector     // Catch:{ all -> 0x000f }
            io.intercom.com.squareup.okhttp.Address r3 = r9.address     // Catch:{ all -> 0x000f }
            io.intercom.com.squareup.okhttp.internal.RouteDatabase r4 = r9.routeDatabase()     // Catch:{ all -> 0x000f }
            r1.<init>(r3, r4)     // Catch:{ all -> 0x000f }
            r9.routeSelector = r1     // Catch:{ all -> 0x000f }
        L_0x0056:
            monitor-exit(r2)     // Catch:{ all -> 0x000f }
            io.intercom.com.squareup.okhttp.internal.http.RouteSelector r1 = r9.routeSelector
            io.intercom.com.squareup.okhttp.Route r8 = r1.next()
            io.intercom.com.squareup.okhttp.internal.io.RealConnection r0 = new io.intercom.com.squareup.okhttp.internal.io.RealConnection
            r0.<init>(r8)
            r9.acquire(r0)
            io.intercom.com.squareup.okhttp.ConnectionPool r2 = r9.connectionPool
            monitor-enter(r2)
            io.intercom.com.squareup.okhttp.internal.Internal r1 = io.intercom.com.squareup.okhttp.internal.Internal.instance     // Catch:{ all -> 0x007d }
            io.intercom.com.squareup.okhttp.ConnectionPool r3 = r9.connectionPool     // Catch:{ all -> 0x007d }
        ...
        L_0x0080:
            monitor-exit(r2)     // Catch:{ all -> 0x007d }
            io.intercom.com.squareup.okhttp.Address r1 = r9.address
            ...
            io.intercom.com.squareup.okhttp.internal.RouteDatabase r1 = r9.routeDatabase()
            io.intercom.com.squareup.okhttp.Route r2 = r0.getRoute()
            r1.connected(r2)
            r6 = r0
            goto L_0x0033
        */
        throw new UnsupportedOperationException("Method not decompiled: io.intercom.com.squareup.okhttp.internal.http.StreamAllocation.findConnection(int, int, int, boolean):io.intercom.com.squareup.okhttp.internal.io.RealConnection");
    }
