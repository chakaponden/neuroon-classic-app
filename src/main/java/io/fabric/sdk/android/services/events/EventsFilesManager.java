...
public abstract class EventsFilesManager<T> {
    ...
    public EventsFilesManager(Context context2, EventTransform<T> transform2, CurrentTimeProvider currentTimeProvider2, EventsStorage eventStorage2, int defaultMaxFilesToKeep2) throws IOException {
        this.context = context2.getApplicationContext();
        this.transform = transform2;
        this.eventStorage = eventStorage2;
        this.currentTimeProvider = currentTimeProvider2;
        this.lastRollOverTime = this.currentTimeProvider.getCurrentTimeMillis();
        this.defaultMaxFilesToKeep = defaultMaxFilesToKeep2;
    }
    ...
    static class FileWithTimestamp {
        ...
        public FileWithTimestamp(File file2, long timestamp2) {
            this.file = file2;
