...
class Onboarding extends Kit<Boolean> {
    ...
    public Onboarding(Future<Map<String, KitInfo>> kitsFinder2, Collection<Kit> providedKits2) {
    ...
    public Map<String, KitInfo> mergeKits(Map<String, KitInfo> scannedKits, Collection<Kit> providedKits2) {
        for (Kit kit : providedKits2) {
