...
public class WeightFragment$$ViewInjector {
    public static void inject(ButterKnife.Finder finder, final WeightFragment target, Object source) {
    ...
    public static void reset(WeightFragment target) {
