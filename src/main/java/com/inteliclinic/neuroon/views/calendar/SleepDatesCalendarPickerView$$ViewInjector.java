...
public class SleepDatesCalendarPickerView$$ViewInjector {
    public static void inject(ButterKnife.Finder finder, final SleepDatesCalendarPickerView target, Object source) {
    ...
    public static void reset(SleepDatesCalendarPickerView target) {
        target.title = null;
