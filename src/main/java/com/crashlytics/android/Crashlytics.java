...
public class Crashlytics extends Kit<Void> implements KitGroup {
    ...
    Crashlytics(Answers answers2, Beta beta2, CrashlyticsCore core2) {
        this.answers = answers2;
        this.beta = beta2;
        this.core = core2;
        this.kits = Collections.unmodifiableCollection(Arrays.asList(new Kit[]{answers2, beta2, core2}));
    }
    ...
    public static class Builder {
        ...
        public Builder core(CrashlyticsCore core2) {
            if (core2 == null) {
