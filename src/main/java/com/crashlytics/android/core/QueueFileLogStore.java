...
class QueueFileLogStore implements FileLogStore {
    ...
    public QueueFileLogStore(File workingFile2, int maxLogSize2) {
    ...
    private void doWriteToLog(long timestamp, String msg) {
        if (this.logFile != null) {
            ...
            try {
                ...
                this.logFile.add(String.format(Locale.US, "%d %s%n", new Object[]{Long.valueOf(timestamp), msg.replaceAll("\r", " ").replaceAll("\n", " ")}).getBytes(HttpRequest.CHARSET_UTF8));
