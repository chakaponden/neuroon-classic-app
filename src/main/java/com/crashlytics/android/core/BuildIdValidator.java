...
class BuildIdValidator {
    ...
    public BuildIdValidator(String buildId2, boolean requiringBuildId2) {
        this.buildId = buildId2;
        this.requiringBuildId = requiringBuildId2;
    }
    ...
    public String getMessage(String apiKey, String appId) {
        return MESSAGE;
    }
}
