...
class NativeCrashWriter {
    ...
    private static abstract class ProtobufMessage {
        ...
        public ProtobufMessage(int tag2, ProtobufMessage... children2) {
            this.tag = tag2;
            this.children = children2 == null ? NativeCrashWriter.EMPTY_CHILDREN : children2;
        }
    ...
    private static final class RepeatedMessage extends ProtobufMessage {
        ...
        public RepeatedMessage(ProtobufMessage... messages2) {
    ...
    private static final class EventMessage extends ProtobufMessage {
        ...
        public EventMessage(long time2, String crashType2, ProtobufMessage... eventMessages) {
            super(10, eventMessages);
            this.time = time2;
            this.crashType = crashType2;
        }
    ...
    private static final class DeviceMessage extends ProtobufMessage {
        ...
        public DeviceMessage(float batteryLevel2, int batteryVelocity2, boolean proximityOn2, int orientation2, long ramUsed2, long diskUsed2) {
    ...
    private static final class LogMessage extends ProtobufMessage {
        ...
        public LogMessage(ByteString logBytes2) {
            super(6, new ProtobufMessage[0]);
            this.logBytes = logBytes2;
        }
    ...
    private static EventMessage createEventMessage(SessionEventData crashEvent, LogFileManager logFileManager, Map<String, String> attributes) throws IOException {
        ...
        return new EventMessage(crashEvent.timestamp, NDK_CRASH_TYPE, applicationMessage, deviceMessage, logByteString != null ? new LogMessage(logByteString) : new NullMessage());
    }
