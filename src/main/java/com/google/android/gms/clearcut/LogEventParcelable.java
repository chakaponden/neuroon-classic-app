...
public class LogEventParcelable implements SafeParcelable {
    ...
    public final zzb.C0001zzb zzafl;
    public final zzb.C0001zzb zzafm;
    ...
    public LogEventParcelable(PlayLoggerContext playLoggerContext, zzsz.zzd logEvent, zzb.C0001zzb extensionProducer, zzb.C0001zzb clientVisualElementsProducer, int[] testCodes) {
        this.versionCode = 1;
        this.zzafh = playLoggerContext;
        this.zzafk = logEvent;
