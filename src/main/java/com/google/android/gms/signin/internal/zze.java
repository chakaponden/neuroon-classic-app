...
public interface zze extends IInterface {
    ...
    public static abstract class zza extends Binder implements zze {
        ...
        private static class C0025zza implements zze {
        ...
        public static zze zzeb(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zze)) ? new C0025zza(iBinder) : (zze) queryLocalInterface;
        }
