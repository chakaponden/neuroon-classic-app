...
public class zza {
    ...
    public static abstract class C0002zza<R extends Result, A extends Api.zzb> extends zzb<R> implements zzb<R>, zzj.zze<A> {
        private final Api.zzc<A> zzaeE;
        private AtomicReference<zzj.zzd> zzagH = new AtomicReference<>();

        protected C0002zza(Api.zzc<A> zzc, GoogleApiClient googleApiClient) {
