...
public final class ConnectionResult implements SafeParcelable {
    ...
    public String toString() {
        return zzw.zzy(this).zzg("statusCode", getStatusString(this.zzade)).zzg("resolution", this.mPendingIntent).zzg(SettingsJsonConstants.PROMPT_MESSAGE_KEY, this.zzafC).toString();
    }
